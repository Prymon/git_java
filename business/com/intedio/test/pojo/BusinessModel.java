...
public class BusinessModel {
	...
	private String SF_CarStyleCode = "01F216A5BF0E411394E1791950327210"; // jeep-������-20082014
	...
	private String tagNum = "0"; // 遮阳板
	private String dropNum = "0"; // 遮阳板
	private String paperNum = "0"; // 遮阳板
	...
	public static Map<String, Object> getMap() {
		...
		/** basic */
		maps_basic.put("sunNum", model.getSunNum()); // �����屨�����ô�ֵΪ1
		...
		maps_basic.put("SF_CarColorCode", model.getSF_CarColorCode()); // ��Χ0-9,��ݿ��Ѿ���10������0-9��Ϊ��ͬ�ĳ�
